...
file_obj = open("data1.txt",'r',encoding='utf-8')
file_write_obj = open("datasql.txt", 'w',encoding='utf-8')
...
for line in all_lines:
    ...
    str='INSERT INTO shuichandata (sheb_id, sheb_num,data_time,get_time,dis_o,ph,w_temp,turbidity)' \
        'VALUES(1,"XSCY10180101TEST0100029","%s","%s",%f,%f,%d,%d);'% (ls[0], ls[1],dis_o,ph,s_tmp,zhuodu)
